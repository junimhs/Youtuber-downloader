...
class Mp3Controller {
  ...
  if(video == null)
    return response.redirect('mp3')
  else
    return view.render('mp3', {link: video.link, video: video})
  }
  ...
  async download({ view, request, response }) {
    ...
    return Youtube.download_mp3( link, title, response )
  }
}
